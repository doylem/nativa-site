...
export default function NativaLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-nativa-navy font-body">
      <SiteHeader />
      ...
      <section className="min-h-screen flex items-center justify-center bg-nativa-navy">
        <div className="text-center text-nativa-ivory p-8 pt-24 md:pt-8 mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-2xl mb-8 max-w-2xl mx-auto leading-relaxed">
            Our mission is to lead the evolution of emerging medicines through
            trusted education that elevates people, businesses and industry
            standards.
          </p>
          <Link href="#elevate">
      ...
      <section id="elevate" className="scroll-mt-16 py-20 px-4 bg-nativa-ivory">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
            Our specialised insights and industry discernment will further your
            capacity to influence and grow your business in the competitive
            Australian market.
          </p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group text-center">
              ...
              <p className="text-gray-600">
                We deliver education to empower Healthcare Practitioners &
                industry professionals with confidence in Australia&apos;s
            ...
            <div className="group text-center">
              ...
              <p className="text-gray-600">
                Let us set you up for success with expert guidance on every step
                of your journey. We assess and refine your operational processes
                to clarify your positioning and potential, while delivering the
                strategic advice, operational expertise, and regulatory
                confidence to strengthen your influence.
              </p>
            </div>
            <div className="group text-center">
              <div className="mb-6 flex justify-center">
              ...
              <p className="text-gray-600">
                Let Nativa lead in the delivery a professional event designed to
                provide attendees with high-quality learning, networking, and
                engagement opportunities in a memorable, time-efficient format.
              </p>
            </div>
            <div className="group text-center">
              <div className="mb-6 flex justify-center">
              ...
              <p className="text-gray-600">
                Effective consulting starts with genuine sector knowledge and
                ends with practical, confidence-boosting solutions.
                Nativa&apos;s consulting services are completely agnostic—rooted
                in science, compliance, and operational best practice, not in
                product deals or backdoor commissions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-playfair font-normal mb-16 text-nativa-ivory text-center">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2 font-semibold text-sm">
                      Up-To-Date, relevant, evidence- based & practical CPD
                      accredited courses.
                    </p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Our tailored programs are expertly delivered to simplify
                      complex concepts and provide practical, evidence-based
                      clinical insights; equipping healthcare professionals with
                      the compliant knowledge to deliver safe, and effective
              ...
              <div className="group cursor-pointer bg-nativa-ivory/90 backdrop-blur-sm hover:bg-nativa-ivory/95 p-6 rounded-lg transition-all shadow-md">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2 font-semibold text-sm">
                      Improve efficiencies, better your bottom line and maximise
                      patient retention with our compliant operational
                      strategies.
                    </p>
                    <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div className="group cursor-pointer bg-nativa-ivory/90 backdrop-blur-sm hover:bg-nativa-ivory/95 p-6 rounded-lg transition-all shadow-md">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      ECS Science; Pharmacy Regulations; New Dose Forms; Patient
                      Management Resources; Pharmacy Compliance; Formulary
                      Guidance & Device Education
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-nativa-ivory">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-playfair font-normal mb-16 text-center text-gray-900">
            Our Team
          </h2>
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-4 order-1 md:order-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                  A qualified Naturopath with a sharp focus on alternative
                  medicine and innovative product formulation, Liz Warburton
                  stands out as Nativa&apos;s product and compliance expert. As
                  operations manager of one of Australia&apos;s busiest
                  pharmacies, Liz oversaw an impressive 700 scripts daily,
                  demonstrating her skill not only in high-volume workflow
                  management but also in scaling operations to drive consistent
      ...
      <section className="py-20 px-4 bg-nativa-navy text-nativa-ivory">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-playfair font-normal mb-16 text-center">
            Testimonials
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4 border-l border-nativa-ivory/30 pl-6">
              ...
              <p className="text-sm leading-relaxed text-gray-100">
                &quot;Thank you to Nativa Education and Consulting for
                delivering some of the most comprehensive and relevant education
                I have ever seen to our pharmacists. You truly are experts in
                this field, and a shining example of what patient advocacy looks
                like.&quot;
              </p>
            </div>
            <div className="space-y-4 border-l border-nativa-ivory/30 pl-6">
              ...
              <p className="text-sm leading-relaxed text-gray-100">
                &quot;It&apos;s all thanks to our brilliant presenters, Rebecca
                Doyle and Liz Warburton. Their expertise and insights made this
            ...
            <div className="space-y-4 border-l border-nativa-ivory/30 pl-6">
              ...
              <p className="text-sm leading-relaxed text-gray-100">
                &quot;We wanted to say a huge thank you for organising such a
                fantastic trivia night - what an absolute hit! The evening
                struck the perfect balance of learning, laughs, and competition.
                Our whole team had such a great time...Thank you again for
            ...
            <div className="space-y-4 border-l border-nativa-ivory/30 pl-6">
              <div>
                ...
                <p className="text-sm text-gray-300">
                  Carina Day & Night Pharmacy
                </p>
              </div>
              <p className="text-sm leading-relaxed text-gray-100">
                &quot;The ladies at Nativa delivered a training that could not
                be faulted or improved upon. Their unique, brand agnostic
                training is genuine and steeped in an infectious enthusiasm and
      ...
      {/* Admired By Section */}
      <section className="py-32 md:py-48 px-4 bg-nativa-ivory">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-4xl md:text-5xl font-playfair font-normal leading-tight text-gray-900">
            Admired by companies and professionals who truly value their{" "}
            <span className="underline decoration-nativa-lime decoration-4 md:decoration-[6px] underline-offset-8">
              people
            </span>{" "}
            &amp;{" "}
            <span className="underline decoration-nativa-lime decoration-4 md:decoration-[6px] underline-offset-8">
      ...
      <section className="relative py-32 px-4 overflow-hidden bg-nativa-navy">
        ...
        <div className="relative z-10 text-center text-nativa-ivory max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-playfair font-normal mb-6">
            A transformational education and consulting practice helping you
            grow your business.
          </h2>
